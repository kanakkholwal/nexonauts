...
export const metadata: Metadata = {
    ...
    description: "Submit your tool to the Dev Tools directory. Share your tool with the community and get feedback from developers.",
}
    ...
    return (<>
        ...
        <div className="flex justify-around items-stretch gap-6">
            ...
            <div className="w-full max-w-xl hidden md:block">
                <Image src={illustration} alt="Submit your tool" width={500} height={500} />
            </div>
        </div>
    </>)
}