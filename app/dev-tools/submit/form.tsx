...
export default function SubmitForm() {
    ...
    return (<div className="flex-auto w-full">
        ...
        <div className="grid gap-5 w-full">
            ...
            <div className="grid w-full items-center gap-1.5">
                ...
                <Input type="email" id="email" placeholder="Email" variant="fluid"
            ...
            <div className="grid w-full items-center gap-1.5">
                ...
                <Input type="url" id="website" placeholder="Enter any of your website, twitter or linkedin url"
                    variant="fluid" value={useFormStore(state => state.website)}
                    onChange={e => useFormStore.setState({ website: e.target.value })} />
            </div>
            <div className="grid w-full items-center gap-1.5">
                <Label htmlFor="github_username">Github Username</Label>
                <Input type="text" id="github_username"
                    placeholder="Github Username" variant="fluid"
                    value={useFormStore(state => state.github_username)}
                    onChange={e => useFormStore.setState({ github_username: e.target.value })} />
            </div>
            <div className="grid w-full items-center gap-1.5">
                <Label htmlFor="github_repo">
                    Github Repo Url
                </Label>
                <Input type="url" id="github_repo"
                    placeholder="Github Repo Url" variant="fluid"
                    value={useFormStore(state => state.github_repo)}
                    onChange={e => useFormStore.setState({ github_repo: e.target.value })} />
            </div>
