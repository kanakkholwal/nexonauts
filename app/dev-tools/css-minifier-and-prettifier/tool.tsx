  ...
  return (
    <div className="flex gap-2 justify-around items-start w-full flex-col lg:flex-row">
        ...
        <CardContent>
          ...
          <Textarea variant="fluid" id="cssField" name="CssValue" rows={10}
        ...
        <CardFooter className="gap-4 justify-center">
          <Button id="minify" variant="dark" onClick={() => {
          ...
          <Button id="beautify" onClick={() => {
            if (value.trim() === "") return

            setOutput(cssbeautify(value, {
              indent: '  ',
              autosemicolon: true
            }))
