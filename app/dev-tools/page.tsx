...
export default function Tools() {
    ...
    return (
        <>
            <section id="hero" className="relative mb-10 flex flex-col items-center justify-center text-center bg-cover bg-center bg-no-repeat py-24 backdrop-blur-xl min-h-96"
            ...
            >
                ...
                <div className="max-w-7xl mx-auto px-6 md:px-12 xl:px-6 relative" >
                    <div className=" text-center mx-auto">
                        <h1 className="text-gray-900 dark:text-white font-bold text-5xl md:text-6xl xl:text-7xl relative bg-gradient-to-r from-primary to-violet-200 bg-clip-text text-transparent dark:from-primaryLight dark:to-secondaryLight">Developer Tools</h1>
                    ...
                    <div className="flex space-x-2 mt-4 relative">
                        ...
                        <Input placeholder="Search dev tools curated from open source projects ..." variant="fluid"
                        aria-label="Search Tools" id="search-tools"
                        className=" py-4 px-5 pl-10 w-full max-w-3xl mx-auto rounded-lg shadow-sm border-primary/20 focus:border-primary" type="search"
