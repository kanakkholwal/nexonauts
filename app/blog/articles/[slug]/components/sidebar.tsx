...
export function SideBar(props:SidebarProps) {
    ...
    return <aside className="@3xl:sticky @3xl:top-5 overflow-hidden space-y-10 p-5 rounded-lg border backdrop-blur-lg shadow w-full @4xl:w-max @4xl:ml-auto shrink-0">
        <div className="flex flex-col items-start space-y-4">
            ...
            <div className="space-y-2">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-300">
                    Learn more <Link href={`/authors/${props.author.username}`} className="underline">about the author</Link>
                </p>
            </div>
        </div>
    </aside>
