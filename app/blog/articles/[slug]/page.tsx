...
const post = {
  ...
  "analytics": { "$oid": "64e336cd3365a8391a6a4051" }, "claps": { "$numberInt": "3" },
  "comments": { "enabled": true },
  createdAt: "2024-06-13T17:32:20.443Z",
  "description": "Deploying your Node.js backend on Vercel using Serverless Functions offers a powerful solution for creating scalable and flexible applications. Learn how to make the most of Express.js ..."
}
...
export default async function PostPage({
  ...
  return (
    <>
      ...
      <PostHeader title={post.title} image={post.image} author={post.author} createdAt={post.createdAt} />
      <main className="w-full mx-auto flex justify-around items-start gap-4 flex-col @4xl:flex-row px-4 lg:px-8 pt-8">
        ...
        <SideBar author={post.author} createdAt={post.createdAt} content={post.content} />
      </main>
      <div>
        <CommentsSection />
      </div>
