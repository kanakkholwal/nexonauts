...
export default function Page() {
    ...
    return (<>
        ...
        <main className="space-y-40 mb-40 max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
            ...
            <section className="font-medium text-base space-y-3 text-slate-600">
                ...
                <h4 className="mb-4 text-xl font-semibold leading-7 tracking-wide text-slate-700">Information We Collect</h4>
                ...
                <h4 className="mb-4 text-xl font-semibold leading-7 tracking-wide text-slate-700">How We Use Your Information</h4>
                ...
                <h4 className="mb-4 text-xl font-semibold leading-7 tracking-wide text-slate-700">Log Files</h4>
                ...
                <h4 className="mb-4 text-xl font-semibold leading-7 tracking-wide text-slate-700">Cookies and Web Beacons</h4>
                ...
                <h4 className="mb-4 text-xl font-semibold leading-7 tracking-wide text-slate-700">Our Advertising Partners</h4>
                ...
                <h4 className="mb-4 text-xl font-semibold leading-7 tracking-wide text-slate-700">Third-Party Privacy Policies</h4>
                ...
                <h4 className="mb-4 text-xl font-semibold leading-7 tracking-wide text-slate-700">CCPA Privacy Rights</h4>
                ...
                <h4 className="mb-4 text-xl font-semibold leading-7 tracking-wide text-slate-700">GDPR Data Protection Rights</h4>
                ...
                <h4 className="mb-4 text-xl font-semibold leading-7 tracking-wide text-slate-700">Data Security</h4>
                ...
                <h4 className="mb-4 text-xl font-semibold leading-7 tracking-wide text-slate-700">Updates to This Policy</h4>
                ...
                <h4 className="mb-4 text-xl font-semibold leading-7 tracking-wide text-slate-700">Contact Us</h4>
