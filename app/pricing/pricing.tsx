        ...
        <>
            ...
            <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
                <div className="text-center">
                    ...
                    <p className=" mx-auto mb-9 font-medium md:text-lg text-slate-600" data-aos="zoom-in-up" data-aos-delay={100}>
                        At Nexonauts, we offer flexible plans tailored to suit every developer, whether you're an individual creator, a growing team, or an enterprise seeking comprehensive solutions.
                ...
                <div className="text-center">
                    ...
                    <p className=" mx-auto mb-9 font-medium md:text-lg text-slate-600" data-aos="zoom-in-up" data-aos-delay={100}>
                        We offer additional services to help you grow your business. Contact us for more information.
                    </p>
                    <ul className="my-4 space-y-2">
                        <li className="flex items-center">
                            <IconCheck className="text-white text-xs bg-green-500 rounded-full mr-2 p-1" />
                            Highlight your products in our marketplace for increased visibility.
                        </li>
                        <li className="flex items-center">
                            <IconCheck className="text-white text-xs bg-green-500 rounded-full mr-2 p-1" />
            ...
            <div className="container px-4 md:px-6">
                <div className="grid grid-cols-1 gap-6 mt-8 md:grid-cols-3 md:gap-8">
                    ...
                    <div className="relative flex flex-col p-6 bg-white shadow-lg rounded-lg dark:bg-zinc-850 justify-between border border-cyan-500 hover:border-sky-500 transition-all duration-300 hover:translate-y-[-16px]">
                        ...
                        <div className="mt-6">
                            <Link href="/signup">
                                <Button className="w-full bg-gradient-to-r from-cyan-500 to-sky-500">Get Started</Button>
                            </Link>
                        </div>
                    </div>
                    <div className="flex flex-col p-6 bg-white shadow-lg rounded-lg dark:bg-zinc-850 justify-between border border-gray-200 hover:border-primary transition-all duration-300 hover:translate-y-[-16px]">
