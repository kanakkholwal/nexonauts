    ...
    <>
      ...
      <section className="font-medium text-base space-y-4 text-slate-600 dark:text-slate-400">
        <p className="mb-3 mt-8">
          ...
          and conditions. Do not continue to use Nexonauts.com if you do not
        ...
        <p>
          Unless otherwise stated, Nexonauts.com and/or its licensors own the
          intellectual property rights for all material on Nexonauts.com. All
        ...
        <ul className="list-disc list-inside">
          <li>Republish material from Nexonauts.com</li>
          <li>Sell, rent, or sub-license material from Nexonauts.com</li>
