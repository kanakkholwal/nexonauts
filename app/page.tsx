                ...
                return (
                  <div key={"solutions_" + index} className="group transition">
                    <div className="relative py-12 p-8">
                      ...
                      <Link
                        href={feature.path}
                        className="flex items-center justify-between group-hover:text-primary mt-5"
                      >
            ...
            <div className="flex justify-between items-stretch flex-col lg:flex-row">
              <div className="py-16 px-6 md:pl-12 md:py-40 lg:py-20 text-center lg:text-start">
                ...
                <p className="mt-6 text-lg text-gray-300">
                  Showcase your projects, skills, and experiences to the world.
                  Create a stunning portfolio that reflects your unique style
                  and personality.
                </p>
                <div className="mt-8 flex justify-center items-center flex-wrap  gap-6">
                  <Button
                    size="lg"
                    className="relative flex h-12 w-full items-center justify-center sm:w-max rounded-full bg-secondary dark:bg-white text-secondary-foreground dark:text-gray-900 hover:bg-secondary/90 dark:hover:bg-white/95 px-6"
                  >
                    Get Started for Free
                  </Button>
                  <Button
                    size="lg"
                    className="relative flex h-12 w-full items-center justify-center sm:w-max rounded-full bg-white/10 text-white hover:bg-white/15 dark:bg-white/10 dark:hover:bg-white/15 px-6"
                  >
                    Live Preview
                ...
                <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="rounded-2xl bg-white/5 text-white p-6">
                    ...
                    <p className="text-gray-300">
                      Showcase your work and skills in a stunning portfolio.
                    </p>
                  </div>
                  <div className="rounded-2xl bg-white/5 text-white p-6">
                    <h3 className="text-lg font-semibold text-white">
                    ...
                    <p className="text-gray-300">
                      Share your portfolio with the world and get discovered.
                    </p>
                  </div>
                  <div className="rounded-2xl bg-white/5 text-white p-6">
                    <h3 className="text-lg font-semibold text-white">
                    ...
                    <p className="text-gray-300">
                      Get discovered by potential employers and collaborators.
                    </p>
                  </div>
                  <div className="rounded-2xl bg-white/5 text-white p-6">
                    <h3 className="text-lg font-semibold text-white">
                    ...
                    <p className="text-gray-300">
                      Grow your career and network with like-minded individuals.
                    </p>
                  </div>
                </div>
              </div>
              <Image
                src="/assets/svg-images/home_profile.svg"
                alt="illustration"
                width={1000}
                height={667}
                className="w-full max-w-full h-full lg:w-1/2 md:w-[60%] m-auto rounded-lg"
              />
            </div>
          </div>
        </div>
                ...
                <div className="divide-y space-y-4 divide-gray-100 dark:divide-gray-800">
                  <div className="mt-8 flex gap-4 md:items-center">
                    ...
                    <div className="w-5/6">
                      ...
                      <p className="text-gray-500 dark:text-gray-400">
                        Become part of a thriving community of developers.
                      </p>
                    </div>
                  </div>
                  <div className="pt-4 flex gap-4 md:items-center">
                    ...
                    <div className="w-5/6">
                      ...
                      <p className="text-gray-500 dark:text-gray-400">
                        Share insights, seek advice, and collaborate with
                        like-minded individuals to propel your projects forward.
                      </p>
                    </div>
                  </div>
                </div>
