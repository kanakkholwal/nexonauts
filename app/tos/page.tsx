...
export default function Page() {
    ...
    return (<>
        ...
        <main className="space-y-40 mb-40 max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
            ...
            <section className="font-medium text-base space-y-4 text-slate-600">
                ...
                <h4 className="mb-4 text-xl font-semibold leading-7 tracking-wide text-slate-700">The following terminology applies to these Terms and Conditions, Privacy Statement, and Disclaimer Notice and all Agreements:</h4>
                ...
                <h4 className="mb-4 text-xl font-semibold leading-7 tracking-wide text-slate-700">Cookies</h4>
                ...
                <h4 className="mb-4 text-xl font-semibold leading-7 tracking-wide text-slate-700">License</h4>
                ...
                <h4 className="mb-4 text-xl font-semibold leading-7 tracking-wide text-slate-700">You must not:</h4>
                <ul className="list-disc list-inside">
                    <li>
                ...
                <h4 className="mb-4 text-xl font-semibold leading-7 tracking-wide text-slate-700">Reservation of Rights</h4>
                <p>We reserve the right to request that you remove all links or any particular link to our website. You approve to immediately remove all links to our website upon request. We also reserve the right to amend these terms and conditions and it's linking policy at any time. By continuously linking to our website, you agree to be bound to and follow these linking terms and conditions.</p>
                <h4 className="mb-4 text-xl font-semibold leading-7 tracking-wide text-slate-700">Removal of Links from Our Website</h4>
                ...
                <h4 className="mb-4 text-xl font-semibold leading-7 tracking-wide text-slate-700">Content Liability</h4>
                ...
                <h4 className="mb-4 text-xl font-semibold leading-7 tracking-wide text-slate-700">Disclaimer</h4>
