...
export function CircularGradient() {
    ...
    >
        <div
            className="m-auto relative inset-x-auto aspect-square rounded-full size-[480px]  sm:size-[928px]  bg-gradient-to-tr from-primary/50 to-purple-400 dark:from-indigo-400  dark:from-10%  dark:via-sky-400  dark:via-30%  dark:to-emerald-300  dark:to-90% opacity-30"
