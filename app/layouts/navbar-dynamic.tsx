...
export default function Navbar() {
    ...
    return (<div aria-label="NavMenu" id="navbar" className="absolute inset-x-0 top-0 z-50  w-full">
        <div className="relative flex items-center justify-between gap-6 py-2 lg:gap-0 lg:py-4 mx-auto px-4 sm:px-12 lg:px-8 backdrop-blur-sm dark:backdrop-blur bg-white/50 dark:bg-zinc-900/20" aria-label="Navbar">
            ...
            <div className="flex lg:flex-1">
                <Link href="/" aria-label="Logo" className="p-1.5">
                    ...
                    <Image height={40} width={280} className="h-8 dark:invert w-auto" src="/assets/logo.svg" alt="Nexonauts Logo" priority loading="eager" />
                </Link>
