...
export const ToggleButton = () => {
  ...
  return (
    <button
      ...
      id="hamburger"
      className="relative lg:hidden h-10 w-10"
  ...
  return (
    <>
      <div
        ...
        className="fixed inset-0 z-10 h-screen w-screen origin-bottom scale-y-0 mx-auto bg-white/70 backdrop-blur-2xl transition duration-500 dark:bg-gray-900/70 lg:hidden"
      />
      <NavigationMenu
        id="navlinks"
        className={cn(
