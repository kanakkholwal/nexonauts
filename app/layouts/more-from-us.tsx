...
export default function MoreFromUs({ omit }: { omit?: string[] }) {
  return (
    <section
      id="more-from-us"
      className="w-full grow mx-auto px-4 sm:px-12 xl:max-w-7xl xl:px-0 relative @container my-10"
    >
      ...
      {features.map((feature) => {
        ...
        return (
          <div
            className="grid grid-cols-1 @2xl:grid-cols-2 gap-4 items-center"
            key={feature.url}
          >
