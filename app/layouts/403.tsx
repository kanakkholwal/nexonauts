  ...
  return (
    <div className="min-h-screen w-full relative overflow-hidden bg-primary/10">
      <nav className="flex justify-between items-center w-full py-3 px-4 md:px-6">
        ...
        <Link
          href="/contact"
          className="flex items-center gap-2 text-slate-700 dark:text-slate-400 hover:underline text-base font-semibold"
        >
        ...
        >
          <defs>
            ...
            >
              ...
              <stop offset="100%" stop-color="#078DEE" stop-opacity={0} />
            </linearGradient>
          </defs>
          <path
            fill="url(#BG)"
