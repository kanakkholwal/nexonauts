...
export default function Navbar() {
  ...
  return (<nav id="navbar" className="fixed inset-x-0 z-20 w-full border-b border-solid border-slate-100/50 dark:border-slate-700 backdrop-blur">
    <div className="mx-auto px-4 sm:px-12 xl:max-w-6xl xl:px-0">
      <div className="relative flex flex-wrap items-center justify-between gap-6 lg:gap-0 lg:py-4">
        <div className="relative z-20 flex w-full justify-between md:px-0 lg:w-max">
          <Link href="/" aria-label="logo" className="flex items-center space-x-2">
            <Image height={40} width={280} className="h-10 dark:invert" src="/assets/logo.svg" alt="logo" />
          </Link>
