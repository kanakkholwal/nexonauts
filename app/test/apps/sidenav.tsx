  ...
  return (
    ...
    >
        ...
        {userRoutes.map((link: LinkType, i) => {
          return (
            <Link
              key={i}
              href={link.path}
              className="inline-flex items-center rounded-md w-full justify-start text-sm group font-semibold text-slate-500 hover:shadow-sm hover:bg-white hover:text-slate-900 dark:text-slate-400  dark:hover:text-slate-900 px-4 py-3 "
            >
      ...
      <div className="mt-auto px-3 py-2">
        <Link
          href="/logout"
          className="inline-flex items-center rounded-md w-full justify-start text-sm group font-semibold text-slate-500 hover:shadow-sm  hover:bg-red-500 hover:text-white px-4 py-3   dark:text-slate-400"
        >
