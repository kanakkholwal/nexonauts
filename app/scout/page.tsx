...
import { ArrowUpDown, FolderOpen, MonitorSmartphone, ScanSearch } from 'lucide-react';
...
const features = [
    {
        ...
        description: "Quickly find the tools and resources you need with our intuitive search functionality. Nexo Scout's powerful search engine makes it easy to locate the perfect solution for your projects and tasks.",
        icon: Search
    },
    {
        name: "Curated Recommendations",
        description: "Explore a handpicked selection of tools and resources tailored to your specific needs and interests. Our team constantly evaluates and updates the database to ensure you have access to the best-in-class solutions.",
        icon: Star
    },
    {
        name: "Regular Updates",
        description: "Stay ahead of the curve with Nexo Scout's continuous updates. We're committed to keeping our database fresh and relevant, providing you with the latest tools, services, and useful websites to enhance your workflow.",
        icon: ShieldCheck
    },
    {
        name: "User-Friendly Interface",
        description: "Navigate our platform effortlessly with a user-friendly interface designed for seamless exploration. Discover new tools, services, and resources with just a few clicks, saving you time and effort in your search for productivity.",
        icon: MonitorSmartphone
    },
    {
        name: "Comprehensive Categories",
        description: "Dive into an extensive range of categories tailored to your field. Whether you're a developer, designer, student, or business owner, easily navigate through specialized categories to find precisely what you need, optimizing your search experience.",
        icon: FolderOpen
    },
    {
        name: "Interactive Filters",
        description: "Refine your search results with interactive filters designed to streamline your browsing experience. Sort by popularity, relevance, or newest additions, ensuring you discover the most relevant tools and resources tailored to your preferences and requirements.",
        icon: ArrowUpDown
    }
] as {
    name: string,
            ...
            <div className="py-32 px-8  min-h-96  w-full flex items-center justify-between max-w-7xl mx-auto relative">
                <div className="max-w-6xl mx-auto text-left pt-5">
                    <h2 className="text-4xl font-bold mb-8 text-slate-800 dark:text-slate-200 max-w-xl text-pretty">
                        Discover Essential Tools & Resources
                        with <span className="relative bg-gradient-to-r from-primary to-violet-600 bg-clip-text text-transparent  md:px-2">
                            Nexo Scout
                        </span>
                    </h2>
                ...
                <div className="hidden md:flex flex-col gap-4 items-center justify-center mt-8">
                    ...
                    <Image src={illustration} height={600} width={600} alt={"Tool scout"}
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:text-center">
                    ...
                    <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-400">
                        Explore Nexo Scout's features: effortless search, curated recommendations, and regular updates. Streamline your workflow with ease and efficiency.
                    </p>
                </div>
                <div className="mt-16 grid  sm:grid-cols-2 lg:grid-cols-3 lg:divide-y-0 rounded-3xl overflow-hidden divide-y">
                    {features.map((feature, index) => {
                        return (<div key={"solutions_" + index} className="hover:bg-gray-100 dark:hover:bg-gray-800">
                            <div className="relative py-12 p-8">
                                <div className="space-y-8 mb-2">
                                    <h5 className="text-lg font-bold text-gray-700 dark:text-white">
                                        <feature.icon className="w-5 h-5 text-primary mr-2 inline-block" />	{feature.name}
                                    </h5>
                                </div>
                        ...
                        tabs={
                            categorized_tools.map((category) => {
                                return {
                                    title: category.name,
                                    value: category.slug,
                                    content: <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                        {category.tools.map((tool) => {
                                            return <Link href={`/scout/tools/${tool.slug}`} key={tool.slug} className="flex flex-col gap-4 items-start  p-4 rounded-lg border hover:bg-slate-100 dark:hover:bg-slate-800">
