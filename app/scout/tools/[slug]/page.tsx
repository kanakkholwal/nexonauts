...
export default async function ToolPage(props: Props) {
  ...
  return (
    <>
      ...
      <CircularGradient />
      <div className="relative grid grid-cols-12 items-start justify-between flex-wrap w-full max-w-7xl mx-auto gap-6 px-4 lg:px-8 pt-32">
        <main className="w-full space-y-10 @container col-span-12 md:col-span-8">
          <Card >
            ...
            <CardHeader className="flex flex-row gap-3 items-center flex-wrap border-t">
              <div className="flex-1 space-y-4">
                <div className="flex flex-row gap-3 items-center justify-start">
                  <CardTitle title={tool.name} className="text-3xl font-bold">
                    {tool.name}
                  </CardTitle>
                </div>
              </div>
        ...
        <aside className="block col-span-12 md:col-span-4 p-4 bg-card rounded-2xl">
