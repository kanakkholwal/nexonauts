  ...
  return (
    <div className="space-y-6 my-5">
      <div className="flex justify-between items-center p-3 gap-4 flex-wrap">
        <h2 className="text-3xl font-semibold">Your Apps</h2>
        <CreateAppButton
          createApp={createApp}
      ...
      <div className="w-full gap-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 2xl:grid-cols-5">
        <Suspense fallback={<div>Loading...</div>}>
          {apps.map((app) => {
            return (
              <Card
                className="w-full max-w-lg hover:border-primary"
              ...
              >
                ...
                <CardContent className="pt-10">
                  <div className="flex justify-center w-full">
                    <Image
                      alt={app.name}
                      src={
                        app.icon ? app.icon : '/assets/images/default_app.png'
                      }
                  ...
                  <CardTitle className="text-center mt-2">{app.name}</CardTitle>
                ...
                <CardFooter className="justify-around items-center gap-2">
                  <Button asChild>
                    <Link href={`/dashboard/apps/${app.appId}`}>Manage</Link>
                  </Button>
          ...
          <CardContent className="pt-10">
            <div className="flex justify-center w-full">
              <Image
                ...
                src={'/assets/images/create_app.png'}
                className="h-16 w-16 aspect-square object-cover"
                height={512}
                width={512}
                draggable={false}
            ...
            <CardTitle className="text-center mt-2">Create New App</CardTitle>
            <CardDescription className="text-center mt-4">
