                ...
                <section className={classes.Section + " " + classes.Hero} id="home">
                    <div className={classes.Container}>
                        <figure className={classes.Hero_banner}>
                            <img src={data.hero.image} width={560} height={540} alt="Kanak Kholwal" className={classes.w_100} data-aos="fade-down" />
                            {/* <img src="./assets/images/hero-shape.svg" width={203} height={91} alt="250+ Projects Done" className={classes.shape} data-aos="fade-down" data-aos-delay="250" /> */}
                        </figure>
                                ...
                                return (
                                    <div className={classes.Projects_card} style={{ backgroundColor: DarkMode ? theme.bg.dark : theme.bg.light }} key={i}>
                                        <div className={classes.Card_content} data-aos="fade-right">
                                            ...
                                            <a href={link} className={classes.btn_text} style={{ color: DarkMode ? theme.color.dark : theme.color.light }} title={"See Project : " + title}>
                                                <span className={classes.span}>See Project</span>
                                                <IoArrowForwardOutline />
                                            </a>
                                        </div>
                                        <figure className={classes.Card_banner} data-aos="fade-left">
                                            <img src={image} width={650} height={370} loading="lazy" alt={category + " - " + title} className={classes.w_100} />
                                        </figure>
                                    </div>
                                )
                            })}
