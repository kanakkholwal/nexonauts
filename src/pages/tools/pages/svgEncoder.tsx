    ...
    return (
        <div className="grid gap-3">
            <div className="flex gap-2 w-full">
                ...
                } size="sm" variant="destructive" className=" font-bold  text-xs">
                    Clear
                </Button>
                <Button onClick={() => {
                ...
                }}  size="sm" variant="dark" className=" font-bold  text-xs">
                Use Example
                </Button>
            ...
            <div className="flex gap-2 w-full">
                ...
                <div className="w-full mx-auto p-2">
                    ...
                    <div className="p-2 w-full rounded border border-dashed border-border"
                     style={{ background: backgroundColor,backgroundImage:`url(${quotes.level1}data:image/svg+xml,${resultValue}${quotes.level1})` }}>
