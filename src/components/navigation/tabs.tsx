...
export default function CatgeoryNavigation({ categories ,key="category"}:Props) {
        ...
        <div className="mb-8 sticky top-6 z-50 justify-center gap-x-2 flex-wrap gap-y-2 hidden sm:flex">
            ...
            <button
                ...
                className={cn(
                    ...
                    activeCategory === "" ?  "bg-white dark:bg-gray-800" : "bg-slate-100 dark:bg-gray-800/40"
                    )}
            >
                All
            </button>
                ...
                {categories.map((item:string) => {
                    return (
                        ...
                        >
                            ...
                            <span
                                className="text-sm xl:text-h6 relative   z-10"
                            >
                                {item}
                            </span>
                        </button>
