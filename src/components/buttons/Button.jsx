...
const Button = styled.button`
  ...
  ${props => props.level ? `
    --btn-text:rgba(var(--${props.nature}-rgb), 1);
    --btn-hover-text:rgba(var(--${props.nature}-rgb), 1);
    --btn-bg:rgba(var(--${props.nature}-rgb), 0.25);
    --btn-box-shadow: none;
    --btn-hover-box-shadow: none;
    --btn-hover-bg:rgba(var(--${props.nature}-rgb), 0.3);
  ...
  ${props => props.size ? `
  --btn-padding-y:var(--${props.size}-btn-padding-y,0.75rem);
  --btn-padding-x:var(--${props.size}-btn-padding-x,1.5rem);
  --btn-line-height:var(--${props.size}-btn-line-height,1.75);
  --btn-border-radius:var(--${props.size}-btn-border-radius,0.5rem);
  ` : ``
  }
