...
export default function Newsletter() {
    return (   <section className="bg-indigo-300 dark:bg-gray-900">
    <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
     <div className="mx-auto max-w-screen-md sm:text-center">
      ...
      <p className="mx-auto mb-8 max-w-2xl font-light text-gray-600 md:mb-12 sm:text-xl dark:text-gray-400">Stay up to date with the roadmap progress, announcements and exclusive discounts feel free to sign up with your email.</p>
      <form onSubmit={(e)=>{
            e.preventDefault()
   ...
   >Subscribe</Button>
       ...
       <div className="mx-auto max-w-screen-sm text-sm text-center text-slate-100 newsletter-form-footer dark:text-gray-300">We care about the protection of your data. <a href="#" className="font-medium text-indigo-600 dark:text-primary-500 hover:underline">Read our Privacy Policy</a>.</div>
      </form>
     </div>
    </div>
   </section>)
