...
export function RingLoader({className, ...props}:React.SVGProps<SVGSVGElement> & {className?: string}){

    return <svg className={cn("w-60 h-60",className)} width={240} height={240} viewBox="0 0 240 240" {...props}>
