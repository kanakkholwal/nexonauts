...
export default function ProductCard({ product }) {
  return (
    <Card className="rounded-3xl border-0 shadow-md shadow-slate-200">
      <CardHeader>
        <Image
      ...
      <CardFooter className="justify-between">
        ...
        <Link
          ...
          className="text-primary font-semibold bg-primary/20 uppercase px-4 py-2 rounded-md"
        >
          Get it now
        </Link>
      </CardFooter>
...
export function ProductCardOnDashboard({ product }) {
  return (
    <Card className="rounded-2xl border-0 shadow-md shadow-slate-200">
      <CardHeader>
        <Image
          src={product.coverImage}
          className="w-96 h-64 object-cover rounded-xl"
