...
export default function FloatingMenu() {
    ...
    return (<div className="fixed z-10 left-0 bottom-0 lg:top-0 right-0 lg:right-auto lg:w-24 bg-slate-100 lg:bg-white shadow-md border-t border-slate-200 pt-1  flex flex-col justify-center">
