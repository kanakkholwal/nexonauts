...
const product_types = [
    { title: 'Templates', href: '/marketplace/explore?type=template', description: "Templates are pre-built websites that you can use as a starting point for your own website." },
    { title: 'UI Kits', href: '/marketplace/explore?type=uikit', description: "UI Kits are collections of components that can be used to build a website." },
    { title: 'E-Books', href: '/marketplace/explore?type=ebook', description: "E-Books are digital books that can be read on your computer, tablet, or phone." },
    { title: 'Plugins', href: '/marketplace/explore?type=plugin', description: "Plugins are software components that add specific features to an existing program." },
    { title: 'Themes', href: '/marketplace/explore?type=theme', description: "Themes are pre-built websites that you can use as a starting point for your own website." },
    { title: 'Graphics', href: '/marketplace/explore?type=graphic', description: "Graphics are pre-built websites that you can use as a starting point for your own website." },
    { title: 'Fonts', href: '/marketplace/explore?type=font', description: "Fonts are pre-built websites that you can use as a starting point for your own website." },
    ...
    { title: 'Courses', href: '/marketplace/explore?type=course', description: "Courses are pre-built websites that you can use as a starting point for your own website." },
    ...
    { title: 'Mobile Apps', href: '/marketplace/explore?type=mobileapp', description: "Mobile Apps are pre-built websites that you can use as a starting point for your own website." },
    { title: 'Desktop Apps', href: '/marketplace/explore?type=desktopapp', description: "Desktop Apps are pre-built websites that you can use as a starting point for your own website." },
    ...
    { title: 'Services', href: '/marketplace/explore?type=service', description: "Services are pre-built websites that you can use as a starting point for your own website." },
    { title: 'Other', href: '/marketplace/explore?type=other', description: "Other are pre-built websites that you can use as a starting point for your own website." },
];
...
export function Navbar({ user, title }: {
    ...
    return (<nav role="navbar" className="w-full flex flex-1 justify-between items-center py-5 px-6 bg-white dark:bg-grey-600 z-20 relative lg:sticky lg:top-0 shadow-sm">
        ...
        <button role="button"
            ...
            <span className="hidden lg:inline-flex">Search templates, ui kits, e-books, and more...</span>
        ...
        {user ? <div className="flex items-center space-x-2 px-3 py-1.5 shrink-0">
            ...
            <Link href="/login" passHref>
                <a className="text-slate-500 text-md mr-2 font-semibold sm:inline-block hidden">Login</a>
            </Link>
            <Link href="/signup" passHref>
                <a className="text-slate-500 text-md mr-2 font-semibold sm:inline-block hidden">Signup</a>
            </Link>
            <Link href="/signup" passHref>
                <a className="text-slate-500 text-md mr-2 font-semibold sm:inline-block hidden">Get Started</a>
            </Link>
        </div>}
    </nav>)
}
