...
const features_for_generalpurpose = [
    ...
    },
    {
        ...
        description: "Our AI Reading tool analyzes your content, suggests improvements"
    },
    {
        Icon: BsTextareaT,
        title: "Text Analysis",
        description: "Our AI Text Analysis tool analyzes your content, suggests improvements"
    },
] as FeatureType[]
const features_for_devs = [
    {
        ...
        description: "Use our tools to automate your application development micro tasks"
    },
    {
        Icon: FcIdea,
        title: "Create your own AI",
        description: "Don't like our AI tool? Create your own AI tool with our AI Builder"
    },
    {
        Icon: FcOpenedFolder,
        title: "Need a generic Feature?",
        description: "Use our open source CLI (CodeGenX) on Web to get boilerplate code"
    },
] as FeatureType[]

export default function SectionFeatures() {
    return (<section className="overflow-hidden pt-17.5 lg:pt-22.5 xl:pt-27.5 scroll-mt-17">
        <div className="max-w-[1222px] mx-auto px-4 sm:px-8 xl:px-0">
            ...
            <div className="relative">
                ...
                <div className="flex flex-wrap justify-center">
                    {features_for_generalpurpose.map((Feature:FeatureType, index: number) => {
                        return (<div className="w-full sm:w-1/2 lg:w-1/3 " key={index}>
                            <div className="group relative overflow-hidden text-center py-8 sm:py-10 xl:py-15 px-4 lg:px-8 xl:px-13 ">
                                ...
                                <h4 className="font-semibold text-lg mb-4">{Feature.title}</h4>
