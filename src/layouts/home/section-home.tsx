      ...
      <div className="mx-auto max-w-[900px] px-4 pt-8 sm:pt-2 sm:px-8 xl:px-0 relative z-1">
        <div className="text-center">
          <span className="hero-subtitle-gradient hover:hero-subtitle-hover text-primary relative mb-5 font-medium text-sm inline-flex items-center gap-2 py-2 px-3 rounded-full">
            ...
            <span className="hero-subtitle-text">Launch Your AI Toolkit</span>
          </span>
          <h1
            className=" mb-6 text-3xl font-extrabold sm:text-5xl xl:text-heading-1"
            data-aos="zoom-in-up"
          >
            Nexo AI Toolkit
          </h1>
          <p
            className="max-w-[500px] mx-auto mb-9 font-medium md:text-lg text-slate-600"
            data-aos="zoom-in-up"
            data-aos-delay={100}
          >
            Nexo AI Toolkit is a collection of AI-powered apps that help you to
