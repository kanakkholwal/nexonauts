        ...
        <div className="max-w-[1170px] mx-auto px-4 my-8 sm:px-8 xl:px-0">
            <div className="cta-box-gradient bg-violet-50 rounded-[30px] relative overflow-hidden px-4 py-20 lg:py-25 z-50">
                ...
                <div className="absolute z-[-10] pointer-events-none inset-0 overflow-hidden">
                    ...
                    <img alt="blur" loading="lazy" decoding="async" data-nimg="fill" className="max-w-none" style={{ position: 'absolute', height: '100%', width: '100%', left: 0, top: 0, right: 0, bottom: 0, color: 'transparent' }} src="https://ai-tool.nextjstemplates.com/images/blur/blur-22.svg" /></span>
                    <span className="absolute w-full h-full left-1/2 bottom-0 -translate-x-1/2 z-[-1]">
                        <img alt="blur" loading="lazy" decoding="async" data-nimg="fill" className="max-w-none" style={{ position: 'absolute', height: '100%', width: '100%', left: 0, top: 0, right: 0, bottom: 0, color: 'transparent' }}
                            src="https://ai-tool.nextjstemplates.com/images/blur/blur-23.svg" /></span><span className="absolute max-w-[530px] aspect-[530/253] left-1/2 bottom-0 -translate-x-1/2 -z-1"><img alt="blur" loading="lazy" decoding="async" data-nimg="fill" className="max-w-none" style={{ position: 'absolute', height: '100%', width: '100%', left: 0, top: 0, right: 0, bottom: 0, color: 'transparent' }} src="/images/blur/blur-24.svg" /></span></div>
                ...
                <div className="wow fadeInUp text-center">
                    <span className="hero-subtitle-gradient relative mb-4 font-medium text-sm inline-flex items-center gap-2 py-2 px-3 rounded-full">
                        ...
                        <span className="hero-subtitle-text">Try our tool for Free</span></span>
                    <h2 className=" mb-4 text-2xl font-extrabold sm:text-4xl xl:text-heading-2">What are you waiting for?</h2>
                    ...
                    <Link className="hero-button-gradient inline-flex rounded-lg py-3 px-7  font-medium ease-in duration-300 hover:opacity-80" href="/signup">Get Started for Free</Link>
                </div>
            </div>
        </div>
    </section>
