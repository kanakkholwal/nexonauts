        ...
        <div className="flex flex-wrap justify-between">
          <div className="mb-10 max-w-[520px] w-full">
            ...
            <p className="mb-12 xl:w-4/5 font-medium text-slate-600">
              {process.env.NEXT_PUBLIC_WEBSITE_NAME} is an open source project
              that aims to provide a complete solution for AI Powered Apps.
            </p>
            <div className="flex items-center gap-5">
              <Link
                href="https://x.com/NexoNauts"
                className="hover:text-primary ease-in duration-300 icon"
              >
          ...
          <div className="max-w-[571px] w-full">
            <div className="flex flex-col sm:flex-row sm:justify-between gap-10">
              <div>
                ...
                <ul className="flex flex-col gap-3">
                  <li>
                    <Link
                      href="/apps"
                      className="text-slate-500 hover:text-primary ease-in duration-300"
                    >
                      Apps
                    </Link>
                  </li>
              ...
              <div>
                <h5 className="font-semibold mb-5">Support</h5>
                <ul className="flex flex-col gap-3">
                  <li>
                    <Link
                      href="/#features"
