    ...
    <>
      <div>
        <div className="flex justify-between items-center gap-2 p-2">
          <Label htmlFor="review" className="font-semibold mb-0">
            Review
          </Label>
...
export default function AllReviews({ app }: { app: AppTypeWithFormFlow }) {
      ...
      <CardContent className="flex gap-2 flex-col pt-2">
        {reviews.map((review, index) => {
          return (
            <div
              key={index}
              className="flex flex-col gap-2 p-1  border-1 border-slate-100"
            >
