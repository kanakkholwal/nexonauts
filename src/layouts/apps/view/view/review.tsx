...
export function PostReview({ app, user }: {
    ...
    const handleSubmit = async () => {
        ...
        await fetch(`${NEXT_PUBLIC_BACKEND_API_URL}/app/${app._id}/review`, {
            method: "POST",
            headers: {
    ...
    return (<>
        <div>
            ...
            <Textarea id="review" placeholder="Write your review here" value={review}
...
export default function AllReviews({ app, user }: {
    ...
    const fetchReviews = async () => {
        setloading(true)
        await fetch(`${NEXT_PUBLIC_BACKEND_API_URL}/app/${app._id}/review/all/paged?page=${page}&limit=5`)
            .then(res => res.json())
            .then(data => {
