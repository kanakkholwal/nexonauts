...
export const cardVariants = tv({
	...
	variants: {
		variant: {
			default: "bg-card text-card-foreground rounded-xl border border-hairline",
			flat: "bg-card rounded-xl border border-hairline",
			elevated: "bg-card rounded-xl border border-hairline shadow-(--shadow-soft-drop)",
			...
			outline: "bg-transparent rounded-xl border border-hairline-strong text-foreground"
		},
		size: {
