...
export default function WelcomeEmail({ payload }: { payload: Payload }) {
  return (
    <Html>
      ...
      <Preview>
        {`🌟 Welcome to ${process.env.NEXT_PUBLIC_WEBSITE_NAME} - Verify Your Account! 🌟 `}{" "}
      </Preview>
      ...
      <Tailwind config={tailwindConfig}>
        ...
        >
          ...
          >
            Welcome to Nexonauts!
          </Heading>
          <Heading as="h3">Dear {payload.name},</Heading>

          <Text className="text-gray-600 mb-6">
            You've taken the first step toward a world of coding efficiency,
            collaboration, and inspiration.
          </Text>
          <Text className="text-lg italic text-gray-700">
            "In the vast universe of code, your possibilities are as limitless
            as the stars. Welcome to Nexonauts, where innovation knows no
            bounds."
          </Text>
          <Text className="text-gray-600 mb-6">
            To kick off your Nexonauts adventure, please click the link below to
            verify your email address and complete your account setup. We can't
          ...
          <Text className="text-gray-600 mt-6">
            If you ever need assistance or have questions, don't hesitate to
            reach out to our stellar support team at{" "}
            <Button
            ...
            . We're here to ensure your journey with Nexonauts is nothing short
            of extraordinary.
          </Text>
          <Text className="text-gray-600 mt-6">
          ...
          <Text className="text-gray-600 mt-2">
            P.S. Remember, "The best way to predict the future is to create it."
